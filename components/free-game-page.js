...
const url = "https://api.rawg.io/api/games?key=ac0b0fc08aed42e99d286cf3e4d5e552&&page_size=100"
let games = document.querySelector("#free-game");

let skeletons = document.createElement("div");
skeletons.setAttribute("id", "free-game-skeletons")
...
setTimeout(() => {
    axios.get(url, {
        ...
        .then((res) => {
            ...
            games.removeChild(document.getElementById("free-game-skeletons"))
