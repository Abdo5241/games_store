...
let games = document.querySelector("#recently-updated-box");


let skeletons = document.createElement("div");
skeletons.setAttribute("id", "recently-updated-box-skeletons")
...
setTimeout(() => {
    ...
    axios.get(url, {
        ...
        .then((res) => {
            ...
            games.removeChild(document.getElementById("recently-updated-box-skeletons"))
