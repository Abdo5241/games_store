...
let games = document.querySelector("#recently-updated-page");


let skeletons = document.createElement("div");
skeletons.setAttribute("id", "recently-updated-page_skeletons")
...
setTimeout(() => {
    ...
    axios.get(url, {
        ...
        .then((res) => {
            ...
            games.removeChild(document.getElementById("recently-updated-page_skeletons"))
