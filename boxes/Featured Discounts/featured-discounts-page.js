...
let games = document.querySelector("#featured-discounts-page");

let skeletons = document.createElement("div");
skeletons.setAttribute("id", "featured-discounts-page_skeletons")
...
setTimeout(() => {
    axios.get(url)
        .then((res) => {
            ...
            games.removeChild(document.getElementById("featured-discounts-page_skeletons"))
