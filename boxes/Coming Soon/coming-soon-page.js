...
let games = document.querySelector("#coming-soon-page");


let skeletons = document.createElement("div");
skeletons.setAttribute("id", "coming-soon-page_skeletons")
...
setTimeout(() => {
    ...
    axios.get(url, {
        ...
        .then((res) => {
            ...
            games.removeChild(document.getElementById("coming-soon-page_skeletons"))
