...
let games = document.querySelector("#coming-soon");


let skeletons = document.createElement("div");
skeletons.setAttribute("id", "coming-soon-skeletons")
...
setTimeout(() => {
    ...
    axios.get(url, {
        ...
        .then((res) => {
            ...
            games.removeChild(document.getElementById("coming-soon-skeletons"))
