...
let games = document.querySelector("#new-releases-page");


let skeletons = document.createElement("div");
skeletons.setAttribute("id", "new-releases-page_skeletons")
...
setTimeout(() => {
    ...
    axios.get(url, {
        ...
        .then((res) => {
            ...
            games.removeChild(document.getElementById("new-releases-page_skeletons"))
