    ...
    <div class="logo_content ">
        <div class="logo">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class=" mr-1.5  text-white  w-7 h-7">
        ...
        <div class="">
            <ul class="nav_list">
                <!-- home -->
                <li class="links_li_sidebar ">
                    <a class="links_li_a" href="Home/Home.html">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                ...
                <!-- My Games -->
                <li class="links_li_sidebar ">
                    <a class="links_li_a" href="index.html">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <!-- Cart -->
                <li class="links_li_sidebar ">
                    <a class="links_li_a" href="cart/cart.html">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <li class="links_li_sidebar ">
                    <a class="links_li_a" href="#">
                        ...
                        <span class="links_name text-white">Help</span>
                    </a>
...
sidebar.innerHTML = generateSidebar(sidebar)
